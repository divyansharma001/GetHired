...
const PersonalInfoSection: React.FC = () => {
  ...
  const { control, handleSubmit, formState: { errors }, watch } = useForm<PersonalInfo>({
    ...
    <form className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <Controller
            name="phone"
            control={control}
            render={({ field }) => <Input id="phone" type="tel" {...field} placeholder="e.g., (123) 456-7890" />}
          />
      ...
      <div>
        ...
        <Controller
            name="location"
            control={control}
            render={({ field }) => <Input id="location" {...field} placeholder="e.g., San Francisco, CA" />}
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <Controller
            name="linkedin"
            control={control}
            render={({ field }) => <Input id="linkedin" {...field} placeholder="e.g., linkedin.com/in/johndoe" />}
          />
        ...
        <div>
          ...
          <Controller
            name="website"
            control={control}
            render={({ field }) => <Input id="website" {...field} placeholder="e.g., johndoe.com" />}
          />
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">Tip: Highlight your key achievements and what you bring to a role.</p>
      </div>
    </form>
  );
};
